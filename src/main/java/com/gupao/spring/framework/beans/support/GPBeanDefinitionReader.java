 ...
 * 负责服务解析配置文件
 *
 * @author lichao chao.li07@hand-china.com 2021-01-16 15:50
 */
public class GPBeanDefinitionReader {
    ...
    /*
     * 将扫描到的配置信息封装成GPBeanDefinition
     */
    public List<GPBeanDefinition> loadBeanDefinitions(){
        //创建的BeanDefinition结果集
    ...
    private void doLoadConfig(String contextConfigLocation){
        ...
        InputStream is = this.getClass().getResourceAsStream("/"+(contextConfigLocation.replaceAll("classpath:","")));
        try{
    ...
    private void doScanner(String scanPackage) {
        ...
        for(File file : classPath.listFiles()){
            //递归调用,如果当前是文件夹继续遍历子文件夹下文件,否则直接取出类名
            if(file.isDirectory()){
